# Terms of Service for Remind

**Last Updated: January 2026**

These Terms of Service ("Terms") govern your use of the Remind mobile application ("App") provided by Creation Methods Limited ("we", "our", or "us").

By downloading, installing, or using Remind, you agree to these Terms.

## 1. Description of Service

Remind is a productivity application that helps you manage reminders, notes, and tasks with AI-powered features.

## 2. Account and Registration

- You must have a valid Apple ID to use certain features
- You are responsible for maintaining the security of your account
- You must provide accurate information when required

## 3. Subscription Terms

### Remind Pro Subscription
- **Price**: Displayed in the app at time of purchase
- **Billing**: Charged monthly to your iTunes Account
- **Free Trial**: New subscribers may be eligible for a 7-day free trial
...
- The App and its content are owned by Creation Methods Limited
...
- You retain ownership of content you create (reminders, notes)
...
- AI-powered features are provided "as is"
- AI suggestions are not guaranteed to be accurate
...
You agree to indemnify and hold harmless Creation Methods Limited from any claims arising from:
- Your use of the App
...
By using Remind, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
